...
class FinishedMatchesHandler:
    ...
    def get_all_matсhes(self)-> list[MatchDTO]:
        try:
            match_dao = MatchDAO()
            ...
            # all_matches_DTO = [[MatchDTO(*[value for value in match.values()]) for match in completed_matches]]
    ...
    def find_matches_by_player_name(self, name:str) -> list[MatchDTO]:
        try:
            match_dao = MatchDAO()
