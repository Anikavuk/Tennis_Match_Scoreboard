...
Revision ID: c3da768df77c
Revises: 
Create Date: 2024-10-23 22:42:01.019849
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["player1_id"], ["players.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["player2_id"], ["players.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["winner_id"], ["players.id"], ondelete="CASCADE"
        ),
